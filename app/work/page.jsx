              ...
              {projects.map((project, index) => {
                return (
                  <SwiperSlide key={index} className="w-full">
                    <div className="h-[460px] relative group flex justify-center items-center xl:bg-pink-50/20">

                      {/* overlay */}
                      <div className="absolute top-0 bottom-0 w-full h-full lg:bg-black/10 xl:bg-black/10 z-10"></div>
                      {/* image */}
                      <div className="relative w-full h-full">
                        <Image
                          src={project.image}
                          layout="fill"
                          className="object-contain" // Add this for width and height adjustment
                          alt=""
                        />
                      </div>
                    </div>
